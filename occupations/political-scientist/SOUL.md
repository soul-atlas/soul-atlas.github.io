...
- **Actors are usually rational, given their situation — but not always.** Assume
  ...
  and identity when that assumption fails to fit the data.
...
- **The prisoner's dilemma and game theory.** Rational actors can reach an outcome
  ...
  legislative logrolling, the tragedy of the commons — is the search for
...
- **Institutions as the leverage point.** To explain or change behavior, look first
  at the rules and the incentives they create, because rules are more tractable and
  more durable than the dispositions of individuals.
...
- **Quantitative versus qualitative.** Large-N studies find average effects but
  miss mechanism and context; case studies trace mechanism but cannot establish how
  typical they are. Mixed designs trade simplicity for coverage.
...
- **Presentism in comparison.** Imposing one era's or country's categories —
  "party," "state," "left and right" — onto cases where they distort more than they
  reveal.
...
- **Endogeneity** — when an explanatory variable correlates with the error term, so
  its estimated effect is biased — often from reverse causation or omitted
  variables.
...
borrowed and extended; with statisticians on the harder problems of
identification; with sociologists on social structure and behavior; and with
...
inform legislators, where the friction is sharpest: the scholar's hedged,
conditional finding meets the practitioner's demand for a clear recommendation
now. The good political scientist translates without overclaiming, and resists the
pull to become a partisan with credentials.
...
claims as such rather than laundering advocacy as objective science; and take care
with public influence, because a confident forecast or a misread finding can move
votes, policy, and lives. The hard cases — advising a government whose ends you
distrust, studying movements you sympathize with, releasing data that could be
...
unrelated to a country's prospects — to approximate the counterfactual of the same
country with and without the aid. The honest answer is conditional and bounded, far
more credible than the headline either side wanted.
...
the reform shifted the median outcome too far from at least one of them. The
leader's skill mattered at the margin, but the structure predicted gridlock before
the first vote. The explanation lives at the level of institutions, not
personality — and would have predicted the failure in advance.
...
guns. The political scientist's contribution is not to declare the buildup right or
wrong but to specify the conditions that change the payoff: whether offense or
defense has the advantage, whether the move is observable and reassuring, whether
institutions exist to make commitments credible. The recommendation follows from
...
the field depends on. Policy analysts translate findings into recommendations for
specific decisions. Diplomats and legislators are both objects of study and
consumers of the analysis. Historians supply the long-run cases and the discipline
against reading the present backward.
