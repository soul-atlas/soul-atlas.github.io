...
unrelated to a country's prospects — to approximate the counterfactual. The honest
answer is conditional and bounded, more credible than the headline either side
wanted.
...
the first vote. The explanation lives at the level of institutions, not personality.
...
defense has the advantage, whether the move is observable, whether institutions
exist to make commitments credible. The recommendation follows from the structure
of the game, not from preference.
