...
A physical therapist assistant exists to turn a physical therapist's plan of care
...
The visible work is leading exercises and walking patients; the actual work is
...
- **The plan of care is the PT's; the execution is yours.** You don't write the
...
- You implement; you do not evaluate. The line between those is the line of your
...
- Does today's response fit the plan, or is this something the PT needs to know
  about?
...
- **Progress / hold / regress.** Each session, read the patient: tolerated last
...
- **Pushing for progress vs. respecting healing.** Drive too hard and you inflame
...
- **Practicing outside scope.** Quietly changing the plan, adding interventions
...
The PTA holds a patient's recovering body in their hands and works at the edge of
...
**The calf that shouldn't have been swollen.** A post-surgical knee patient
...
The PTA's identity is implementing a clinician's plan with skilled hands and
