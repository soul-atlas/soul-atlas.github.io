...
A preschool teacher exists to grow the foundations of a human being during the
...
The visible work looks like singing, gluing, and refereeing the block corner;
...
- **Play is the engine, not the reward.** A child at deep play is doing the
...
- **Zone of Proximal Development (Vygotsky).** Teach into the gap between what a
...
- What is this child telling me with this behavior, and what skill is missing
  under it?
...
- **Co-regulate, then teach.** In a meltdown, connect and calm first; the lesson
  lands only once the body is back online.

## Workflow

1. **Prepare the environment.** Set the centers and seed provocations tied to the
...
- **Pushing academics down.** Drilling letters on fours who need blocks, mistaking
...
- **Loving the easy ones.** Pouring attention into the sunny children and quietly
  losing the dysregulated or quiet ones.
...
- **Developmentally appropriate practice (DAP)** — teaching matched to age,
...
- **The prepared room and its centers** — blocks, dramatic play, sensory table,
...
A preschool teacher holds the youngest, most vulnerable children during the years
...
A preschool teacher shares the developmental focus of many roles but is defined by
