...
The past does not survive; only traces of it do. A historian reconstructs what happened,
...
Build the most defensible account of the past the surviving evidence can support, made
...
- **Triangulation.** Trust no fact on a single source if it can be checked against another
...
1. **Question.** Frame a problem the sources can answer. Too broad drowns; too narrow
   says nothing.
...
- **Presentism.** Reading present values and knowledge into people who could not have held
...
- **Historiography** — how history has been written; the prior interpretation a historian
  argues within.
