...
- The record is a sample, never the population, and not random — it favors the
  literate, the powerful, and the durable.
...
- We know how the story ends and the people in it did not; this asymmetry distorts
  every judgment unless deliberately corrected.
- A document tells you what someone wanted recorded, not what happened.
- The questions you bring decide what counts as evidence; there are no facts prior to
  a question.
...
- **Periodization as a tool, not a fact.** Boundaries like "the Renaissance" are
  conveniences imposed later. Use them to organize, but check whether the period marks
...
1. **Question.** Frame a problem the sources can actually answer. Too broad drowns;
   too narrow says nothing.
2. **Survey the historiography.** Find out what has already been argued and where the
   live disputes are. You cannot contribute to a conversation you have not heard.
...
5. **Read and note.** Work systematically, transcribing carefully, recording
   provenance and call numbers so every claim can be traced back. The footnote is the
   proof.
...
- **Breadth versus depth.** The synthesis covering a century cannot pause over the one
  document that complicates it; the microhistory that does cannot generalize. Choose
  the scale your question requires and accept what it blinds you to.
- **Narrative readability versus fidelity.** A clean story sells and teaches; the past
  was messier. Smoothing the contradictions is a lie of omission, but burying the
  reader in qualifications is a failure of craft.
...
- **The citation apparatus** — footnotes and endnotes are the audit trail that lets
  any reader retrace and contest the argument.
...
- **Digital humanities** — text mining, databases, network analysis, and GIS for
  patterns across corpora too large to read by hand; dangerous when it hides the
  source criticism underneath.
- **Oral history methods** — structured interviewing, aware that memory reconstructs
  and rehearses rather than records.
...
archaeologists and anthropologists for periods that left few texts; and with each
other through peer review, conferences, and the footnote that says "but see." The
field advances by disagreement on shared evidence. The recurring friction is between
the specialist who has read every document and the synthesizer who must compress a
field into a chapter, and between the scholar's caution and the public's appetite for
a clean, usable past.

## Ethics

The historian holds a quiet power: to confer or withhold remembrance, to legitimize
or puncture the stories nations and institutions tell about themselves. Core duties:
represent the evidence honestly, including what wounds your thesis; do not fabricate,
omit, or distort to serve a politics, however just the cause feels; give voice to
those the record tried to erase without inventing words they never spoke; respect the
dead by reconstructing them as they were, not as we would prefer; and disclose your
own standpoint rather than posing as a view from nowhere. The hard cases — living
descendants' pain, contested national memory, documents kept by regimes that should
not have kept them — rarely resolve cleanly, but they are betrayed most by the
historian who pretends there was no choice to make.

## Scenarios

**A founding chronicle that is too good.** A historian studying a kingdom's origins
has one rich narrative source, written a century later by a court historian,
describing the dynasty's rise as destined and virtuous. The amateur quotes it; the
expert distrusts it precisely because it is convenient. Who paid this author, and what
did the dynasty need believed? Reading against the grain, the historian mines it not
for its claims but for its assumptions — the rivals it bothers to denounce reveal a
...
finds meticulous records of crop yields, shipping, and profits, and almost nothing in
the enslaved people's own voices, because the system that kept the ledgers denied them
the page. The temptation is to write only the planters' history because that is what
survives. Following Trouillot, the historian treats the silence as data: reads the
ledgers against the grain for births, deaths, sales, and resistance recorded only as
"losses," supplements with court records and later oral testimony handled with full
awareness of memory's drift, and states plainly where the evidence stops. The result
reconstructs more than the archive intended without inventing what it cannot support.

**Was the war inevitable?** Asked to explain a great-power war, the historian
separates the proximate trigger — an assassination, an ultimatum — from the underlying
conditions of alliances, armament, and domestic pressure. Rather than declare the
outcome fated or accidental, they run a disciplined counterfactual: given the choices
the decision-makers actually saw, at which junctures could a different plausible choice
have changed the path? The answer is neither pure contingency nor iron determinism but
a structured account of where agency operated inside constraint — and a refusal of the
hindsight that makes the catastrophe look obvious to everyone except those who lived
it.
...
general laws of society where historians attend to the particular and the changing.
Archivists and librarians keep the sources, deciding what survives to be studied.
Curators interpret the material past for a public. Political scientists analyze power
and institutions that historians watch change over centuries.
