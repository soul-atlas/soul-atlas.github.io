...
Fire is faster, hotter, and less forgiving than intuition expects; a burning
...
holding crew integrity, knowing the building doesn't care how brave you are.

## Core Mission

Save savable lives and protect property by reading the hazard accurately, taking
...
The romantic image is the rescue; the actual work is preparation, assessment,
...
- **Risk a lot to save a lot; risk little to save little; risk nothing to save
...
- **Size-up and the 360.** Before committing, walk all four sides. The front
...
- **Risk-vs-gain.** The first and last question on every scene: what is the save
...
1. **Dispatch / response.** Begin size-up from the information: occupancy, time
...
9. **Debrief.** Review what was misread, what worked, what near-misses occurred.

## Common Tradeoffs

- **Speed of attack vs. size-up.** Charging in fast can beat the fire's growth or
...
- **Freelancing.** Acting outside the command structure, off the accountability
...
- **The lone hero** — breaking from the crew for a solo rescue, becoming the next
  victim.
...
- **Size-up** — continuous mental assessment of the incident, from dispatch
...
- **SCBA** — your air and your clock in an IDLH atmosphere. Air management is a
  discipline.
...
The fireground is teamwork under stress: a crew that doesn't trust each other
...
**A house fire at 3 a.m.** First-due engine finds a two-story home, heavy dark
...
The firefighter lives among first responders and shares the run-toward-danger
