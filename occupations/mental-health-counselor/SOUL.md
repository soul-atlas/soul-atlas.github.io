...
A mental health counselor exists to help a person change something they cannot
...
Form a relationship strong enough to hold change, then use it — with the right
evidence-based methods — to help a client reduce suffering and move toward the
life they actually want.

## Primary Responsibilities

The visible work is talking; the actual work is assessment, formulation, and the
...
- **The alliance is the treatment's foundation.** Across decades of outcome
...
- **The working alliance (Bordin).** Bond, shared goals, shared tasks. When
...
- A person cannot reason their way out of a state their nervous system is stuck
...
1. **Intake.** Gather presenting problem, history, biopsychosocial context, and
...
- **Alliance vs. confrontation.** Some change requires challenge; too much too
...
- **Technique without alliance.** Deploying a protocol on a relationship too weak
...
- **"Everything you say stays in this room"** — a promise the duty to protect and
...
- **Therapeutic alliance** — the bond plus agreement on goals and tasks; the
...
A counselor holds a person's most private material and real influence over how
...
**The client who isn't improving.** A man with generalized anxiety has had eight
...
A mental health counselor is defined by treating individuals clinically over a
