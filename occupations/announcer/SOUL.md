...
- **Talk to one person.** The audience is thousands, but each listener is alone
  in a car or a kitchen. "Hey everybody" is dead air with words. Picture one
...
- Mark your copy: slash the pauses, underline the stresses, circle the brand
  name.
- Read the intro time before you open the mic, not while you're talking.
...
- **Hit the post:** finish a talk-up exactly as the vocal of the song begins.
...
- **IFB / talkback:** the producer's voice fed into the announcer's ear while
  on-air ("interruptible foldback").
...
feeding cues, times, and changes through the IFB while the announcer keeps
