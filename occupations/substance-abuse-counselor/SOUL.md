...
A substance abuse counselor exists to help people change a relationship with
...
The visible work is counseling; the actual work is engaging the unengageable and
...
- People don't change because they're told to; they change when staying the same
...
- **Stage-matched intervention.** Precontemplation: build rapport, no pushing.
...
1. **Engage.** Before assessment, build rapport and partnership — especially with a
...
- **The righting reflex.** Lecturing the client into defending their use, then
...
- **Motivational interviewing** — the core method, especially OARS and change-talk
  evocation.
...
A substance abuse counselor works at a busy intersection. They coordinate with MAT
...
**The mandated, "in denial" client.** A man sent by the court after a DUI opens
...
A substance abuse counselor is defined by treating addiction across ambivalence
