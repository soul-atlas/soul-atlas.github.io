...
The visible work is digging; the actual work is disciplined control of context.
...
6. **Recover the unseen.** Sieve and float soil for seeds, bones, microdebris,
   and residues a trowel would miss.
...
- **Treating the record as a Pompeii snapshot.** Ignoring formation processes and
  reading discard, decay, and disturbance as if they were living behavior.
...
- **The trowel** — the four-inch pointing trowel, instrument of careful removal
