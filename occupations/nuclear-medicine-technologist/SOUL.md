...
Nuclear medicine turns the patient into the source of the image. Instead of
...
Deliver the right radiopharmaceutical, in the right activity, to the right patient
at the right time, acquire a diagnostic study of physiologic function, and keep
radiation exposure to patient, public, and self as low as reasonably achievable.

## Primary Responsibilities

The visible work is injecting a tracer and running a camera; the real work is
...
- **ALARA is the whole job, not a poster on the wall.** Time, distance, shielding
...
- **Time, distance, shielding — the ALARA triad.** Every protective action maps
...
- You cannot see, smell, or feel radiation; the instruments are your only senses,
...
- **Dose calculation and verification.** Read the prescription, decay-correct to
...
1. **Start-of-day QC.** Dose calibrator constancy, camera uniformity/flood,
...
- **Image quality vs. patient dose.** More activity means more counts and a
...
- One step back beats a lead apron for a point source — use the inverse-square
  law first.
...
- **Decay-math error.** Injecting a dose calculated for calibration time hours
...
The technologist sits between the radiopharmacy, the physician, and the patient.
...
The technologist holds the public's trust to handle radioactive material no one
...
**The decayed dose at the end of a delayed morning.** A sestamibi cardiac dose was
...
walked through the department mattered more than the small dose at the bench.

## Related Occupations

The technologist shares the imaging suite with radiologic technologists but works
