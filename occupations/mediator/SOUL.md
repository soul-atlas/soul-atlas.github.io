...
**BATNA** — Best Alternative To a Negotiated Agreement; the benchmark every offer is judged against.
**WATNA** — Worst Alternative To a Negotiated Agreement; the downside of no deal.
**ZOPA** — Zone Of Possible Agreement; the overlap of acceptable ranges where a deal can exist.
**Reservation point** — a party's bottom line, the least favorable terms they'll accept.
**Interests vs. positions** — underlying needs vs. stated demands.
**Caucus** — a private, confidential meeting between mediator and one side.
**Joint session** — all parties together with the mediator.
**Reality-testing** — Socratic questioning that helps a party see the true strength and risk of their case.
**Impasse** — a stuck point where movement stops; usually a signal, not an endpoint.
**Mediator's proposal** — a single settlement package, accepted or rejected privately by each side.
**Self-determination** — the principle that the parties, not the mediator, decide the outcome.
