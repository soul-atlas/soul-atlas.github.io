...
invisible patterns of collective life visible, and treating the taken-for-granted
as something to be accounted for rather than assumed.
...
4. **Enter the field / the data.** Conduct interviews, write fieldnotes, administer
...
- **Depth vs. breadth.** Ethnography yields rich understanding of a few cases;
  surveys yield thin, comparable data on many. You rarely get both.
...
- **Insider vs. outsider standpoint.** The insider sees meaning the outsider misses
  but is blind to what familiarity normalizes; the outsider sees the strange but
  misreads it.
...
- **Smuggling values as findings.** Letting a political commitment determine the
  conclusion and dressing it as neutral analysis.
...
culture problem — bad choices passed down. The sociologist refuses the
individual-blame frame and reconstructs the structure: redlining cut off mortgage
capital, factory closures removed the jobs, disinvestment followed. Comparative-
historical data and interviews show the "culture" is an adaptation to constrained
opportunity, not its cause — Mills's move from private trouble to public issue. The
recommendation targets the structure (capital, jobs), not the residents' character,
holding agency and structure together: people choose, but inside a field someone else
built.
...
and whose interests the alarm serves — Goffman's frames and Cohen's moral panic
working together.
