...
Build demonstrable, industry-current competence — verified against the standard a
...
- **Competence is demonstrated, not described.** A student who can explain a weld
...
- Would this work pass on the job site, in the shop, in the clinic — not just in my
  gradebook?
...
1. **Map the program of study backward from the credential and the job.** Anchor to
...
- **Breadth of exposure vs. depth of mastery.** Sampling many skills produces a
...
- **Lecturing a hands-on craft.** Death by slideshow when the skill lives in the
...
- **The chalk-and-talk shop class** — all theory, minimal hands-on, in a room full
  of idle equipment.
...
- **Competency-based education (CBE)** — progression gated by demonstrated skill,
  not seat time.
...
- **The shop, lab, clinic, or kitchen** — the working environment that is the
...
A CTE teacher shares the general K-12 craft but is defined by teaching to an
